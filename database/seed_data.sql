...
('AAU Qiyas Project', 'Cybersecurity & Digital Risk Management Program', 'Completed', 'security', 'Jul 2026 - Sep 2026', 'Addis Ababa, Ethiopia', 'Intensive professional program covering Blue Team and Red Team security operations.', ARRAY['Blue Team and SIEM operations, threat intelligence and incident response', 'Red Team operations and penetration testing of web and network targets', 'Linux and server administration; VLAN, VPN and routing', 'Digital risk management, GRC, and secure SDLC / DevSecOps monitoring']::TEXT[], 1),
('Ethiopian CyberShield 2026', 'National Cybersecurity Exercise', 'Certified', 'security', 'Sep 17 - 20, 2026', 'Addis Ababa, Ethiopia', 'Four-day national cybersecurity event hosted by ALX Ethiopia, SecureLabs, Yekolo Temari and Gundan.', ARRAY['Completed four days of hands-on system hardening, Red Team operations and incident response exercises']::TEXT[], 2),
...
('Information Network Security Administration (INSA)', '4th Cyber Talent Summer Camp Program', 'Program', 'security', 'Summer 2025', 'Addis Ababa, Ethiopia', 'National cybersecurity talent program run by INSA in collaboration with AASTU.', ARRAY['Completed offensive and defensive security modules in lab environments', 'Developed a Python/Flask web vulnerability scanner as the final project']::TEXT[], 4);
...
('Ethiopian CyberShield 2026', 'ALX Ethiopia, SecureLabs, Yekolo Temari & Gundan', 'September 2026', NULL, '/certificates/ethiopian-cybershield-2026.jpg', 2),
